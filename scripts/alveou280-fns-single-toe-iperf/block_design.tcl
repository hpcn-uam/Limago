...
# module references:
# axi4stream_constant, axi4stream_sinker, interface_settings, performance_debug_reg, bandwith_reg, bandwith_reg, bandwith_reg, axi4stream_sinker, bandwith_reg, bandwith_reg, cycle_limiter, tcp_checksum_axis, tcp_checksum_axis, bandwith_reg, size_checker, axi4stream_sinker, bandwith_reg, bandwith_reg, bandwith_reg
...
proc create_hier_cell_TCP { parentCell nameHier } {
  ...
  create_bd_intf_pin -mode Slave -vlnv xilinx.com:interface:axis_rtl:1.0 TCP
  create_bd_intf_pin -mode Slave -vlnv xilinx.com:interface:diff_clock_rtl:1.0 ddr4_c0_ref_clk
  ...
  connect_bd_intf_net -intf_net ddr4_ref_clk_1 [get_bd_intf_pins ddr4_c0_ref_clk] [get_bd_intf_pins memory_controller_c0/C0_SYS_CLK]
  ...
  connect_bd_net -net memory_controller_c0_addn_ui_clkout1 [get_bd_pins clk_100MHz] [get_bd_pins memory_controller_c0/addn_ui_clkout1]
...
proc create_hier_cell_interface_0_handler { parentCell nameHier } {
  ...
  connect_bd_intf_net -intf_net Conn2 [get_bd_intf_pins ddr4_c0_ref_clk] [get_bd_intf_pins TCP/ddr4_c0_ref_clk]
  ...
  connect_bd_net -net TCP_addn_ui_clkout1_0 [get_bd_pins clk_100MHz] [get_bd_pins TCP/clk_100MHz]
...
proc create_hier_cell_Interfaces { parentCell nameHier } {
  ...
  set cmac_wrapper_0 [ create_bd_cell -type ip -vlnv naudit:cmac:cmac_ALVEOu280_0:1 cmac_wrapper_0 ]
  ...
  connect_bd_intf_net -intf_net TX_Traffic_0_1 [get_bd_intf_pins TX_Traffic_0] [get_bd_intf_pins cmac_wrapper_0/AXI2LBUS]
  connect_bd_intf_net -intf_net cmac_ALVEOu280_0_0_LBUS2AXI [get_bd_intf_pins Rx_Traffic_0] [get_bd_intf_pins cmac_wrapper_0/LBUS2AXI]
  connect_bd_intf_net -intf_net cmac_ALVEOu280_0_0_gt_tx [get_bd_intf_pins gt_if0_tx] [get_bd_intf_pins cmac_wrapper_0/gt_tx]
  connect_bd_intf_net -intf_net cmac_interconnect_M00_AXI [get_bd_intf_pins cmac_interconnect/M00_AXI] [get_bd_intf_pins cmac_wrapper_0/AXI4_STATISTICS]
  ...
  connect_bd_intf_net -intf_net gt_if0_ref_clk_1 [get_bd_intf_pins gt_if0_ref_clk] [get_bd_intf_pins cmac_wrapper_0/gt_ref_clk]
  connect_bd_intf_net -intf_net gt_if0_rx_1 [get_bd_intf_pins gt_if0_rx] [get_bd_intf_pins cmac_wrapper_0/gt_rx]

  # Create port connections
  connect_bd_net -net aresetn_1 [get_bd_pins p_arst_n_100] [get_bd_pins cmac_interconnect/aresetn] [get_bd_pins cmac_wrapper_0/s_axi_reset_n]
  connect_bd_net -net cmac_ALVEOu280_0_0_usr_rx_clk [get_bd_pins cmac_if0_rx_clk] [get_bd_pins cmac_wrapper_0/usr_rx_clk]
  connect_bd_net -net cmac_ALVEOu280_0_0_usr_tx_clk [get_bd_pins cmac_if0_tx_clk] [get_bd_pins cmac_wrapper_0/usr_tx_clk]
  ...
  connect_bd_net -net init_clk_1 [get_bd_pins clk_100MHz] [get_bd_pins cmac_interconnect/aclk] [get_bd_pins cmac_sync_0/s_axi_aclk] [get_bd_pins cmac_wrapper_0/s_axi_aclk] [get_bd_pins vio_cmac_synq_0/clk]
...
proc create_root_design { parentCell } {
  ...
  set ddr4_c0_ref [ create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:diff_clock_rtl:1.0 ddr4_c0_ref ]
  set_property -dict [ list \
  ...
  connect_bd_net -net clk_100MHz_conn [get_bd_pins Interfaces/clk_100MHz] [get_bd_pins Memory_Mapped/clk_100MHz] [get_bd_pins interface_0_handler/clk_100MHz] [get_bd_pins synq_reset_system/clk_100MHz]
